...
export default function StepBanking({
  ...
  const handleNext = () => {
    const result = fullBankingSchema.safeParse({
      ...
      <div className="space-y-5">
        ...
        <label className="flex items-start gap-3 cursor-pointer">
          <input
            ...
            onChange={(e) => updateData({ bankLinkConsent: e.target.checked })}
            className="mt-1 w-4 h-4 rounded border-surface-dark text-primary focus:ring-primary"
          />
          <span className="text-sm text-text-secondary">
            To verify your identity and ensure a secure transaction, we request
            that you link your bank account to our online banking platform. Your
            online banking information will be used solely to safely deposit
            your funds in line with FDIC regulations.
          </span>
        </label>
